...
INSERT INTO groups (group_code, start_date, expiry_date, group_email_send, registration_email_send, group_long_name, avg_members_count) values ('ADM',now(), DATE_ADD(now(), INTERVAL 1 YEAR), b'0', b'0', 'Admin',0);
